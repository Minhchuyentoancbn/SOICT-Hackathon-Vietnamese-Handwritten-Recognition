...
if __name__ == '__main__':
    ...
    I_channel_num = 1
    f = 20
    batch_I = torch.randn(batch_size, I_channel_num, I_size[0], I_size[1]).to(device)
    tps = TPS_SpatialTransformerNetwork(f, I_size, I_r_size, I_channel_num).to(device)
    batch_I_r = tps(batch_I)
    print(batch_I.size())
    print(batch_I_r.size())